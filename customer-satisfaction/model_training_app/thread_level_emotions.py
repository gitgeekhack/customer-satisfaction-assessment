...
def extract_data(file_path, idx):
    customer_response = ""
...
for i in range(len(lst_dir)):
    customer_responses[i], thread_ids[i] = extract_data("../data/dataset/" + lst_dir[i], i)
...
model_obj = BuildModel(data)  # initialize object of BuildModel

print("Training of Model...")
data = model_obj.train_and_predict()
